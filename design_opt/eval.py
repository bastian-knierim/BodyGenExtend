...
#agent.visualize_agent_video(num_episode=1, video_dir=train_dir) # for creating a video
#agent.eval_data(out_csv_path=os.path.join(train_dir, 'eval_data.csv'))  # for tracking data
agent.visualize_agent_frames(out_dir=train_dir)  # for creating frames
# agent.debug()