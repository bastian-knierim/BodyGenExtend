...
class SwimmerPushEnv(MujocoEnv, utils.EzPickle):
    def __init__(self, cfg, agent):
        ...
        if self.cfg.xml_name == "default":
            self.model_xml_file = os.path.join(cfg.project_path, "assets", "mujoco_envs", "swimmerbox.xml")
        else:
    ...
    def step(self, a):
        ...
        # execution stage
            ...
            max_nsteps = done_condition.get('max_nsteps', 1500)
            termination = False
